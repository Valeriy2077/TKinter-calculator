...
display_text = Entry(main, font=("Archangelsk",20,"bold"),textvariable=input_value,bd=30,insertwidth=4, 
...
btn_sum = Button(main,padx=16,bd=8,fg="black",font=("arial",20,"bold"),text="+",command=lambda: buttonClick("+"))
...
btn_C = Button(main,padx=16,bd=8,fg="black",font=("arial",20,"bold"),text="C",command=buttonC)
btn_C.grid(row=4,column=1) 

btn_ravno = Button(main,padx=16,bd=8,fg="black",font=("arial",20,"bold"),text="=",command=buttonRavno)
btn_ravno.grid(row=4,column=2) 

btn_delenie = Button(main,padx=16,bd=8,fg="black",font=("arial",20,"bold"),text="/",command=lambda: buttonClick("/"))
btn_delenie.grid(row=4,column=3) 
